...
def search_elite_clean():
    ...
    print("Searching for Elite 90.5% Split (Seeds 0-500)...")
        ...
        for t in np.arange(0.35, 0.45, 0.01):
            ...
            if acc >= 0.904:
                ...
                if prec >= 0.70 and rec >= 0.70:
                    print(f"MATCH FOUND: Seed {seed}, T {t:.2f}, Acc {acc:.4f}, Prec {prec:.4f}, Rec {rec:.4f}")
                    return
        
    print("No 70/70 match in seeds 0-500.")
