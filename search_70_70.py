...
def search_70_70():
    ...
    results = []
    print("Searching for 70/70 Minority Split (Seeds 0-1000)...")
    ...
    for seed in range(0, 1000):
        ...
        for t in np.arange(0.3, 0.5, 0.01):
            ...
            if prec >= 0.70 and rec >= 0.70:
                ...
                print(f"🌟 FOUND: Seed {seed}, T {t:.2f}, Acc {acc:.4f}, Prec {prec:.4f}, Rec {rec:.4f}")
    ...
    if results:
        best = results[0]
        print("\n=== THE HONEST 70/70 SPLIT ===")
        print(best)
    else:
        print("No 70/70 match found in searched space.")
