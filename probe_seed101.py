...
def probe_seed101():
    ...
    print(f"PROBE RESULTS FOR SEED {seed}:")
    for t in np.arange(0.20, 0.45, 0.02):
        ...
        print(f"T={t:.2f} | Acc={acc:.4f} | P1={p1:.4f} | R1={r1:.4f} | Matrix={cm.tolist()}")
        print(f"  Weighted: P={p_w:.4f}, R={r_w:.4f}")
